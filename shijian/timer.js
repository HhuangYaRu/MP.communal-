    	...
    	function cPlugin(o,emlnum){
    		var sjObj=o;
		        ...
		        sjObj.defaults={
		            ...
		            df_box:function(){return $("</div><div class='df-box slideInUp"+(sjObj.opt.alwaysShow?"alwaysShow":"")+" "+sjObj.opt.boxClassName+"' style='line-height:"+sjObj.opt.height+"px;'></div>")},
